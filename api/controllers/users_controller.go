...
import (
	...
	"errors"
	"fmt"
	"github.com/SemmiDev/go-combo/api/auth"
	"github.com/SemmiDev/go-combo/api/models"
	"github.com/SemmiDev/go-combo/api/responses"
	formaterror "github.com/SemmiDev/go-combo/api/utils/format_error"
...
func (s *Server) UpdateUser(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		responses.ERROR(w, http.StatusUnauthorized, errors.New(ErrUnauthorized))
		return
	}
	if tokenID != uid {
